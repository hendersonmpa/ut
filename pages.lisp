...
(define-easy-handler (all-docs :uri "/all-docs") ()
  (standard-page (:title "Physicians")
    ...
    (:p (:img :src "/figures/barchartAUTHORIZING_PROVIDER_NAME.png" :alt "barchar"  :align "middle"))
    (:p (:img :src "/figures/AUTHORIZING_PROVIDER_NAMEts.png" :alt "timeseries" :align "middle"))
...
(define-easy-handler (all-locs :uri "/all-locs") ()
  (standard-page (:title "Ordering Locations")
    ...
    (:p (:img :src "/figures/barchartORDERING_DEPARTMENT_NAME.png" :alt "barchart"))
    (:p (:img :src "/figures/ORDERING_DEPARTMENT_NAMEts.png" :alt "timeseries"))
...
(define-easy-handler (all-pats :uri "/all-pats") ()
  (standard-page (:title "Patients")
    ...
    (:p (:img :src "/figures/barchartMRN.png" :alt "barchart"))
    (:p (:img :src "/figures/MRNts.png" :alt "timeseries"))
...
(define-easy-handler (all-labs :uri "/all-labs") ()
  (standard-page (:title "Labs")
    ...
    (:p (:img :src "/figures/barchartRESULTING_SECTION_NAME.png" :alt "barchart"))
    (:p (:img :src "/figures/RESULTING_SECTION_NAMEts.png" :alt "timeseries"))
...
(define-easy-handler (all-tests :uri "/all-tests") ()
  (standard-page (:title "Tests")
    ...
    (:p (:img :src "/figures/barchartTEST_NAME.png" :alt "barchart"))
    (:p (:img :src "/figures/TEST_NAMEts.png" :alt "timeseries"))
